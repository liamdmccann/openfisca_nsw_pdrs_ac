...
setup(
    ...
    url = "https://github.com/Openfisca-NSW/openfisca_nsw_pdrs_ac",
    include_package_data = True,  # Will read MANIFEST.in
    data_files = [
        ("share/openfisca/openfisca_nsw_pdrs_ac", ["CHANGELOG.md", "LICENSE", "README.md"]),
        ],
    install_requires = [
        'OpenFisca_nsw_base'
