...
class F14_is_installed_on_single_gas_fired_steam_boiler(Variable):
    value_type = bool
    entity = Building
...
class F14_is_installed_on_multiple_gas_fired_steam_boilers(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F14_is_not_residential_building(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F14_replaces_existing_end_user_equipment(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F14_has_existing_sensor_based_blowdown_control(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F14_sensor_based_blowdown_control_installed_at_commissioning(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F14_meets_eligibility_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        installed_on_single_gas_fired_steam_boiler = buildings('F14_is_installed_on_single_gas_fired_steam_boiler', period)
        installed_on_multiple_gas_fired_steam_boilers = buildings('F14_is_installed_on_multiple_gas_fired_steam_boilers', period)
        is_not_residential = buildings('F14_is_not_residential_building', period)
        replaces_existing_equipment = buildings('F14_replaces_existing_end_user_equipment', period)
        has_existing_blowdown_control = buildings('F14_has_existing_sensor_based_blowdown_control', period)
        had_blowdown_at_commissioning = buildings('F14_sensor_based_blowdown_control_installed_at_commissioning', period)
