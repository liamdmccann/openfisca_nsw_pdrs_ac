...
class F11_gas_savings(Variable):
    value_type = float
    entity = Building
...
class F11_current_equipment_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class F11_existing_equipment_type(Variable):
    value_type = Enum
    possible_values = F11EquipmentType
    default_value = F11EquipmentType.steam_boiler
    entity = Building
    definition_period = ETERNITY
