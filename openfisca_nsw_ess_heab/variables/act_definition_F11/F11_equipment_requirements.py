...
class F11_replacement_end_user_equipment_is_gas_fired_burner(Variable):
    value_type = bool
    entity = Building
...
class F11_replacement_is_linkageless(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F11_replacement_has_minimum_4_1_turn_down_ratio(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F11_replacement_can_receive_flue_gas_sensor_signal(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F11_meets_equipment_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        is_gas_fired_burner = buildings('F11_replacement_end_user_equipment_is_gas_fired_burner', period)
        replacement_nameplate_capacity = buildings('F11_replacement_equipment_capacity', period)
        condition_over_1000kW = (replacement_nameplate_capacity > 1000)
        is_linkageless = buildings('F11_replacement_is_linkageless', period)
        has_4_1_turndown_ratio = buildings('F11_replacement_has_minimum_4_1_turn_down_ratio', period)
        can_receive_gas_sensor_signal = buildings('F11_replacement_can_receive_flue_gas_sensor_signal', period)
