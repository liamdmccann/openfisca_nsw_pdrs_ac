...
class F10_end_user_equipment_has_oxygen_trim_system(Variable):
    value_type = bool
    entity = Building
...
class F10_oxygen_trim_system_has_flue_gas_sensor(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F10_trim_system_capable_of_controlling_burner_air_supply(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F10_trim_system_capable_of_controlling_variable_speed_drive(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F10_meets_equipment_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        has_oxygen_trim_system = buildings('F10_end_user_equipment_has_oxygen_trim_system', period)
        has_flue_gas_sensor = buildings('F10_oxygen_trim_system_has_flue_gas_sensor', period)
        can_control_burner_air_supply = buildings('F10_trim_system_capable_of_controlling_burner_air_supply', period)
        can_control_variable_speed_drive = buildings('F10_trim_system_capable_of_controlling_variable_speed_drive', period)
